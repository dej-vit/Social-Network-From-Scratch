...
<body>
	...
	* {
	...
	if($count != 0) {
	    ...
	    $profile_query = mysqli_query($con, "SELECT * FROM users WHERE username ='$userLoggedIn'");
          ...
          $last_name = $row['last_name'];
			...
			<div class="comment_section">
				<a href="<?php echo $posted_by?>" target="_parent"><img src='assets/images/profile_pics/<?php echo $profile_pic;?>' title="<?php echo $posted_by; ?>" style="float:left;" height="30"></a>
				<a href="<?php echo $posted_by?>" target="_parent"> <b>
				 <?php echo $first_name ." ". $last_name; ?> </b></a>
