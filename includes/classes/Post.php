			...
			while($row = mysqli_fetch_array($data_query)) {
				...
				if($row['user_to'] == "none") {
					...
					$user_to_obj = new User($this->con, $row['user_to']);
					 /*$user_to = "to <a href='" . $row['user_to'] . "'> ". $user_to_obj->getFirstAndLastName() . "</a>";*/
				...
				if($user_logged_obj->isFriend($added_by)){
					...
					$str .= "<div class='status_post' onClick='javascript:toggle$id(event)'>
								<div class='post_profile_pic'>
								 <img width='50' src='assets/images/profile_pics/" . $user_row['profile_pic']." '>	
								</div>

								<div class='posted_by' style='color:#ACACAC;'>
									<a href='$added_by'> $first_name $last_name  </a><span> $user_to </span>&nbsp;&nbsp;&nbsp;&nbsp;<span>$time_message</span>
									$delete_button
								</div>
								<div id='post_body'>
									$body
