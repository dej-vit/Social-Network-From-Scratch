		...
		while($row = mysqli_fetch_array($usersReturnedQuery)) {
			...
			echo "<div class='search_result'>
					...
					<div class='result_profile_pic'>
						<a href='" . $users['username'] ."'> <img style='height:100px;' src='assets/images/profile_pics/" 
						. $users['profile_pic']." ' ></a>
					</div>

						<a href='" . $users['username'] ."'> " . $users['first_name'] . " " . $users['last_name'] . "
						<p id='grey'> " . $users['username'] ."</p>
						</a>
						<br>
						" . $mutual_friends ."<br>
